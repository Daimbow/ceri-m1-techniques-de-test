...
/**
 * IPokedex interface. An IPokedex aims to store all information about captured
 * pokemon, as their default metadata as well.
 * 
 * @author fv
 */
public interface IPokedex extends IPokemonMetadataProvider, IPokemonFactory {
  ...
  /**
   * Adds the given <tt>pokemon</tt> to this pokedex and returns it unique
   * index.
   * 
   * @param pokemon
   *          Pokemon to add to this pokedex.
   ...
   * 
   * @param id
   *          Unique pokedex relative identifier.
   * @return Pokemon denoted by the given identifier.
   * @throws PokedexException
   *           If the given <tt>index</tt> is not valid.
   */
  ...
  /**
   * Returns an unmodifiable list of all pokemons this pokedex contains. The
   * list view will be sorted using the given <tt>order</tt>.
   * 
   * @param order
   *          Comparator instance used for sorting the created view.
